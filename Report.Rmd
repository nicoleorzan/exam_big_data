...
Usually, graphs talking about Demoghraphic Transition show togheter the data about death and birth rate of a Country, togheter with the population trend, into a certain time frame (<a href="https://en.wikipedia.org/wiki/Demographic_transition#/media/File:Demographic-TransitionOWID.png">Wikipedia example</a>)<br />
Let's have a look at those quantities' trends in Italy:
