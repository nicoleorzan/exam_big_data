...
<figure>
<img src="Images/overpop.jpg" style="position:absolute;top:50px;right:170px;" width=650 border="0">
</figure>
...
<figure>
<img src="Images/kaggle.png" style="position:absolute;top:220px;right:670px;" width=250 border="0">
</figure>

<figure>
<img src="Images/eco.png" style="position:absolute;top:400px;right:670px;" width=250 border="0">
</figure>
...
c <- data.frame("Year" = c("8000 B.C", "1200" ,"1750", "1850", "1950", "2017"), 
                ...
                "Ever_Born_People" = c("1.137.789.769", "73.754.465.125", "89.708.399.091","4.046.240.009" , "100.045.075.171", "108.470.690.115") )
kable(c)
```
...
* **<span style="color:green">Stage One</span>**: Pre-Industrial Revolution, high birth rates and death rates
* **<span style="color:green">Stage Two</span>**: The Country is developing, death rates tents to diminish while birth rates stay high: population is growing
* **<span style="color:green">Stage Three</span>**: Births starts to decrease thanks to the better economic and living conditions
* **<span style="color:green">Stage Four</span>**: Birth rates and death rates are both low, so population is stabilizing
* **<span style="color:green">Stage Five</span>** (possible stage): Birth rates have fallen below death rates, the population is older
...
<figure>
<a href="https://data.worldbank.org/">
<img src="Images/logo.jpg" style="position:absolute;top:60px;right:30px;" width=120 alt="logo" border="0">
</a>
</figure>
