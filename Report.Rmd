...
To do so, I will try to make a prediction using the **Logistic model for Population Growth**$^{[6]}$, which can be described by the Pearl-Reed differential equation:
...
This model is not perfect maybe, but...
