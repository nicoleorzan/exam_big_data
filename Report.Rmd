...
Let's move to the next point: we want to know if we can predict what will happen to the world population amount.
</div>
<div class="column-right">
<figure>
<a href="http://overpop2013.weebly.com/uploads/1/7/2/9/17291870/497887430.jpg">
<img src="Images/popgrowth.jpg" width=400  border="0"></a> </figure>
<br /></div>

And so, let's try to predict what will be the World's population in the next years. To do so, I will use the **Logistic model for Population Growth**, which can be described by the Pearl-Reed logistic equation:
