...
To have an estimate of the world's population from year one AD, I took also data from here: https://www.ecology.com/population-estimates-year-2050/. <br />
...
Apart from this, we can say that those data frames are tidy: the primary key is obviously present (the Country name), each variable is set in only one column, and each observations has its own row, if we consider each year as a variable on its own. In some of my later use, however, the "Year" will become a variable, and I will have to use the **gather** function to modify my dataset. <br />
...
<img src="Images/popgrowth.jpg" style="position:absolute;top:6070px;right:300px;" width=350 alt="Go to W3Schools!" border="0">
</a>
</figure>
